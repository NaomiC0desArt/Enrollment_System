...
namespace UniversitySystem.Application.Migrations
{
    ...
    [Migration("20260407121826_update_User_Fields")]
    partial class update_User_Fields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("UniversitySystem.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 4, 7, 12, 18, 24, 519, DateTimeKind.Utc).AddTicks(437),
                            ...
                            Role = 1,
                            UpdatedAt = new DateTime(2026, 4, 7, 12, 18, 24, 519, DateTimeKind.Utc).AddTicks(440)
                        });
                });
